						...
						<?php else : ?>
							...
							?>
								...
								<li>
									<!-- <div class="dashboard-box-listing"> -->
										...
										<div class="item-listing">
											...
											<div class="item-listing-details">
												...
												<!-- Details -->
												<div class="item-listing-description jm-dashboard-job" style="margin-bottom: 0;">
									...
									<!-- Candidates Status Bar -->
									<div class="item-listing-stats job-item">
										<?php
										if (class_exists('WP_Job_Manager\Stats_Dashboard')) {
											$stats_dashboard = \WP_Job_Manager\Stats_Dashboard::instance();
											if (method_exists($stats_dashboard, 'output_job_stats')) {
												$stats_dashboard->output_job_stats($job);
											}
										}
										?>
									</div>

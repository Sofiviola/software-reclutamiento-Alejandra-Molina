		...
		if (is_user_logged_in() && sizeof($resumes)) : ?>
			<form class="apply_with_resume" method="post">
				...
				<p>
					...
					<textarea name="application_message" cols="20" rows="4" placeholder="Escribe aquí un mensaje para está propuesta" required><?php
				...
				<p>
					<input type="submit" style="margin-top: 14px;" name="wp_job_manager_resumes_apply_with_resume" id="send_application_button" value="<?php esc_attr_e('Send application', 'workscout'); ?>" />

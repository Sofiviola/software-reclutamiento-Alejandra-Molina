...
?>
        ...
        <!-- Intro Banner
    ================================================== -->
        <div class="intro-banner dark-overlay <?php if ($settings['white_space'] == 'yes') {  echo "extra-white-space"; } ?>" <?php  if ($settings['new_background_image'] == null ) { ?>data-background-image="<?php echo esc_url($settings['background']['url']); ?>"<?php } ?>
                                                >

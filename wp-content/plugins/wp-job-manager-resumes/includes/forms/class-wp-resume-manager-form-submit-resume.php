	...
	public function init_fields() {
		...
		$this->fields = apply_filters(
			...
			[
				'resume_fields' => [
					'candidate_name'       => [
						'label'         => __( 'Nombre', 'wp-job-manager-resumes' ),
						'type'          => 'text',
						'required'      => true,
						'placeholder'   => __( 'Escribe tu nombre completo', 'wp-job-manager-resumes' ),
						'priority'      => 1,
						'personal_data' => true,
					],
					'candidate_email'      => [
						'label'         => __( 'Email', 'wp-job-manager-resumes' ),
						'type'          => 'text',
						'required'      => true,
						'placeholder'   => __( 'Escribe tu email', 'wp-job-manager-resumes' ),
						'priority'      => 2,
						'personal_data' => true,
					],
					'candidate_title'      => [
						'label'         => __( 'Título profesional', 'wp-job-manager-resumes' ),
						'type'          => 'text',
						'required'      => true,
						'placeholder'   => __( 'Ej: "Web Developer"', 'wp-job-manager-resumes' ),
						'priority'      => 3,
						'personal_data' => true,
					],
					'candidate_location'   => [
						'label'         => __( 'Ciudad', 'wp-job-manager-resumes' ),
						'type'          => 'text',
						'required'      => true,
						'placeholder'   => __( 'Ej: "Buenos Aires", "Córdoba", "Rosario"', 'wp-job-manager-resumes' ),
						'priority'      => 4,
						'personal_data' => true,
					],
					'candidate_linkedin'   => [
						...
						'type'               => 'text',
						'required'           => false,
						'placeholder'        => 'Ingresa tu LinkedIn. Ej: https://www.linkedin.com/in/username',
						'priority'           => 5,
						'personal_data'      => true,
					],
					'candidate_phone'      => [
						'label'              => __( 'Teléfono', 'wp-job-manager-resumes' ),
						'type'               => 'text',
						'required'           => true,
					...
					'candidate_dni'        => [
						'label'              => __( 'DNI', 'wp-job-manager-resumes' ),
						'type'               => 'text',
						'required'           => true,
					...
					'resume_file'          => [
						'label'         => __( 'Cargar CV', 'wp-job-manager-resumes' ),
						'type'          => 'file',
						'required'      => false,
						'ajax'          => true,
